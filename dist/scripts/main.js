...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helpers_bascetHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/bascetHelper */ \"./src/helpers/bascetHelper.js\");\n/* harmony import */ var _helpers_itemsHelper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/itemsHelper */ \"./src/helpers/itemsHelper.js\");\n/* harmony import */ var _renderCategories__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./renderCategories */ \"./src/renderCategories.js\");\n/* harmony import */ var _renderProducts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./renderProducts */ \"./src/renderProducts.js\");\n\r\n\r\n\r\n\r\n\r\nwindow.onscroll = function () { onScrollFooter() };\r\n\r\n// Get the header\r\nvar header = document.getElementById(\"header\");\r\n\r\n// Get the offset position of the navbar\r\nvar sticky = header.offsetTop;\r\n\r\n// Add the sticky class to the header when you reach its scroll position. Remove \"sticky\" when you leave the scroll position\r\nfunction onScrollFooter() {\r\n  if (window.pageYOffset > sticky) {\r\n    header.classList.add(\"sticky\");\r\n  } else {\r\n    header.classList.remove(\"sticky\");\r\n  }\r\n}\r\n\r\ndocument.addEventListener(\"DOMContentLoaded\", function () {\r\n\r\n  let params = (new URL(document.location)).searchParams;\r\n  let filter = params.get('filter');\r\n\r\n  let items = _helpers_itemsHelper__WEBPACK_IMPORTED_MODULE_1__.itemsHelper.getItems();\r\n\r\n  if (filter) {\r\n    items = items.filter(i => i.category === filter);\r\n  }\r\n\r\n  document.getElementById(\"items-list\").innerHTML = (0,_renderProducts__WEBPACK_IMPORTED_MODULE_3__.renderProducts)(items);\r\n  document.getElementById(\"bascet-count\").innerHTML = _helpers_bascetHelper__WEBPACK_IMPORTED_MODULE_0__.bascet.getItemsInBascet().length;\r\n  document.getElementById('categories').innerHTML = (0,_renderCategories__WEBPACK_IMPORTED_MODULE_2__.renderCategories)();\r\n\r\n  document.querySelectorAll(\".main-contents-list-item_addToBascet\").forEach((button) => {\r\n\r\n    button.addEventListener(\"click\", (event) => {\r\n      let element = event.target;\r\n      let key = event.target.getAttribute(\"key\");\r\n\r\n      element.classList.toggle(\"main-contents-list-item_addedToBascet\");\r\n\r\n      if (_helpers_bascetHelper__WEBPACK_IMPORTED_MODULE_0__.bascet.containsElement(key)) {\r\n        element.innerHTML = \"Add to bascet\";\r\n        _helpers_bascetHelper__WEBPACK_IMPORTED_MODULE_0__.bascet.deleteElement(key);\r\n      } else {\r\n        element.innerHTML = \"Added to bascet\";\r\n        _helpers_bascetHelper__WEBPACK_IMPORTED_MODULE_0__.bascet.addElement(key);\r\n      }\r\n\r\n      document.getElementById(\"bascet-count\").innerHTML = _helpers_bascetHelper__WEBPACK_IMPORTED_MODULE_0__.bascet.getItemsInBascet().length;\r\n    });\r\n  });\r\n});\n\n//# sourceURL=webpack://internet-shop/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"renderProducts\": () => (/* binding */ renderProducts)\n/* harmony export */ });\n/* harmony import */ var _helpers_bascetHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/bascetHelper */ \"./src/helpers/bascetHelper.js\");\n/* harmony import */ var _renderProduct__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderProduct */ \"./src/renderProduct.js\");\n\r\n\r\n\r\nfunction renderProducts(items) {\r\n    let html = \"\";\r\n    //itemsHelper.getItems\r\n\r\n    if (items) {\r\n        items.forEach(element => {\r\n            let isInBascet = _helpers_bascetHelper__WEBPACK_IMPORTED_MODULE_0__.bascet.containsElement(element.title);\r\n\r\n            html += (0,_renderProduct__WEBPACK_IMPORTED_MODULE_1__.renderItem)(element, isInBascet);\r\n        });\r\n    }\r\n\r\n    return html;\r\n}\n\n//# sourceURL=webpack://internet-shop/./src/renderProducts.js?");
